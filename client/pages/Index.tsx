  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      <style>{`
        ...
        .wish-btn:hover {
          background: #1a3a5c; transform: scale(1.1);
        }
        .wish-btn.active {
          background: #ff9d4d;
        }
        ...
        .offer-card {
          ...
          border: 2px solid rgba(255, 157, 77, 0.2); transition: all 0.3s ease;
        }
        .offer-card:hover {
          border-color: rgba(255, 157, 77, 0.5); transform: translateY(-4px);
        ...
        .input-field textarea {
          width: 100%; padding: 12px 16px; border: 2px solid #e8eef8;
          border-radius: 8px; font-family: inherit; transition: all 0.3s ease;
        }
        .input-field input:focus,
        .input-field textarea:focus {
          outline: none; border-color: #ff9d4d;
        ...
        .feature-icon {
          ...
          display: flex; align-items: center; justify-content: center; color: #1a3a5c;
        }
      `}